...
function index() {
  ...
  const posts = data.boxes?.filter((box) => box.id == pId);
  return (
    <div>
      {posts.map((post) => (
        <div
          ...
          <div className="flex flex-col bg-white py-xl px-sp">
            <div className="flex sm:flex-col">
              <div className="w-[45%] sm:w-[100%]">
                ...
                <Clock />
                <div className="my-mm w-[320px] h-[200px] iam:w-[320px] imo:w-[240px] sm:w-[320px] sm:w-auto sm:h-[190px] sm:my-mm relative">
                  <Image
                    src={post.image}
                    alt="bourse"
                    layout="fill"
            ...
            <div className="flex justify-between items-center mt-xl">
              ...
              <Link href={`http://localhost:3000/education/box/` + post.ID}>
